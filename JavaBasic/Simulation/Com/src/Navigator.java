...
public abstract class Navigator {
    ...
    public double calAngle(double dx, double dy) {  //向→是0度角，顺时针旋转
        ...
        //System.out.println("create angle : " + angle);        //创建的角度以正右为0度，顺时针增大角度
        return angle;
    }
    public double getAngle(){  //向上为0的坐标系    --------获取对象当前朝向
