...
//        group.getChildren().add(new AmbientLight());
  ...
  private Box prepareBox() {
    ...
    material.setDiffuseMap(  //这是获取 路径的方法    相对路径
    		new Image(getClass().getResourceAsStream("../assets/textures/threed/wood.jpg"))
    	);
    material.setBumpMap(
    		new Image(getClass().getResourceAsStream("../assets/textures/threed/illuminati2.jpg"))
    	);
