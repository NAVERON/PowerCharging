...
//        group.getChildren().add(new AmbientLight());
  ...
  private Box prepareBox() {
    ...
    material.setDiffuseMap(new Image(getClass().getResourceAsStream("../assets/textures/threed/wood.jpg")));

    //Set self illumination map
    material.setSelfIlluminationMap(new Image(getClass().getResourceAsStream("../assets/textures/threed/illuminati2.jpg")));
